...
const API_PEDIDOS    = '../back-end/pedidos.php';
...
function renderizarProdutos() {
    ...
    produtos.forEach(produto => {
        ...
        const textoEstoque  = produto.emEstoque ? 'Marcar esgotado' : 'Marcar disponível';
        const classeEstoque = produto.emEstoque ? 'marcar-esgotado' : 'marcar-disponivel';
